    ...
    public UserFeedback levelDescription(Game game) {
        ...
        if (firstVisit) {
            ...
            Narrator.tell(UserFeedback.of(
                    "It might cheer you up, but is that what you should be doing? Maybe time would be better spent searching for the quest that Lars sent you on?"));
        }
        return UserFeedback.of("Maybe you'll find something in here?");
    }
}
